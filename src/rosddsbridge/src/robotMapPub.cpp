...
{
  ros::init(argc,argv,"robotMapPub");
  ros::NodeHandle nh;
  ...
  wqos_pcl.history().kind = KEEP_ALL_HISTORY_QOS;
  //wqos_pcl.history().depth = 100;
  ...
  wqos_pcl.durability().kind = eprosima::fastdds::dds::TRANSIENT_LOCAL_DURABILITY_QOS;
