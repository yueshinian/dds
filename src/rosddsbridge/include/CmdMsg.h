...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(CmdMsg_SOURCE)
#define CmdMsg_DllAPI __declspec( dllexport )
#else
#define CmdMsg_DllAPI __declspec( dllimport )
#endif // CmdMsg_SOURCE
#else
#define CmdMsg_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define CmdMsg_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure CmdMsg defined by the user in the IDL file.
 * @ingroup CMDMSG
 */
class CmdMsg
{
public:
     ...
     */
    eProsima_user_DllExport CmdMsg();
     ...
     * @param x Reference to the object CmdMsg that will be copied.
     */
    eProsima_user_DllExport CmdMsg(
            const CmdMsg& x);
     ...
     * @param x Reference to the object CmdMsg that will be copied.
     */
    eProsima_user_DllExport CmdMsg& operator =(
            const CmdMsg& x);
