...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(PoseMsg_SOURCE)
#define PoseMsg_DllAPI __declspec( dllexport )
#else
#define PoseMsg_DllAPI __declspec( dllimport )
#endif // PoseMsg_SOURCE
#else
#define PoseMsg_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define PoseMsg_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure PoseMsg defined by the user in the IDL file.
 * @ingroup POSEMSG
 */
class PoseMsg
{
public:
     ...
     */
    eProsima_user_DllExport PoseMsg();
     ...
     * @param x Reference to the object PoseMsg that will be copied.
     */
    eProsima_user_DllExport PoseMsg(
            const PoseMsg& x);
     ...
     * @param x Reference to the object PoseMsg that will be copied.
     */
    eProsima_user_DllExport PoseMsg& operator =(
            const PoseMsg& x);
